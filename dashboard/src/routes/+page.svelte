...
<main class="sanctum-page antialiased">
	...
	{:else}
		<section class="workspace sanctum-shell">
			...
			<section class="next"><Eye size={18} /><div><strong>Redaktion bereit</strong><span>Orakel, Fragmente, Profilkarten und Whisper können direkt gepflegt werden.</span><nav><a href="/oracles">Orakel</a><a href="/fragments">Fragmente</a><a href="/profiles">Profilkarten</a><a href="/whispers">Whisper</a><a href="/chronicle">Chronik</a>{#if data.isOwner}<a href="/curator-chat">Schattenfunk</a><a href="/curator-card">Kuratorin-Karte</a><a href="/admin">Administration</a>{/if}</nav></div></section>
		</section>
	{/if}
</main>
