<script lang="ts">
	...
	const labels = { oracle: 'Orakel', fragment: 'Fragment', profile: 'Profilkarte', whisper: 'Whisper', whisper_target: 'Whisper-Zielperson', admin_config: 'Administration', curator_card: 'Kuratorin-Karte' } as const;
