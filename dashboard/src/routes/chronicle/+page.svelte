<script lang="ts">
	...
	const labels = {
		...
		profile: 'Profilkarte',
		whisper: 'Whisper',
		whisper_target: 'Whisper-Zielperson',
		admin_config: 'Administration',
		curator_card: 'Kuratorin-Karte',
		curator_chat: 'Schattenfunk',
		curator_persona: 'Charakter-Preset'
	} as const;
	const actions = { create: 'angelegt', update: 'bearbeitet', delete: 'gelöscht', restore: 'wiederhergestellt', send: 'gesendet' } as const;
</script>
...
<style>
	...
	:global(.sanctum-page .timeline article) { background: var(--surface-raised) !important; }
